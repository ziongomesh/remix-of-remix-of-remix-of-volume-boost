// Base de médicos por estado — Hapvida
// Mínimo 10 médicos por cidade principal de cada estado disponível

export interface MedicoHapvida {
  nome: string;       // DR. NOME SOBRENOME
  crm: string;        // CRM 00000-UF
  especialidade: string;
  cidade: string;
  uf: string;
}

export const MEDICOS_HAPVIDA: MedicoHapvida[] = [
  ...
  // ─── CEARÁ (CE) ─────────────────────────────────────────────────────────────
  { nome: 'DR. ADAM FONTELES JÚNIOR', crm: 'CRM 18762-CE', especialidade: 'Clínica Médica', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. BRUNA QUEIROZ SARAIVA', crm: 'CRM 24310-CE', especialidade: 'Pediatria', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DR. CAIO REBOUÇAS MOTA', crm: 'CRM 15985-CE', especialidade: 'Cardiologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. DANIELA HOLANDA PINTO', crm: 'CRM 30654-CE', especialidade: 'Ginecologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DR. EDGAR NOGUEIRA VASCONCELOS', crm: 'CRM 20187-CE', especialidade: 'Ortopedia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. FLÁVIA ARAÚJO CAVALCANTE', crm: 'CRM 35421-CE', especialidade: 'Neurologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DR. GUSTAVO LEITÃO BEZERRA', crm: 'CRM 17834-CE', especialidade: 'Dermatologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. HELOÍSA CARNEIRO FEITOSA', crm: 'CRM 42100-CE', especialidade: 'Psiquiatria', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DR. ÍTALO MOREIRA COUTINHO', crm: 'CRM 21450-CE', especialidade: 'Gastroenterologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. JEANE SILVA MACEDO', crm: 'CRM 28900-CE', especialidade: 'Endocrinologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DR. KLÍNIO TÁVORA SANTIAGO', crm: 'CRM 14572-CE', especialidade: 'Urologia', cidade: 'Fortaleza', uf: 'CE' },
  { nome: 'DRA. LETÍCIA PONTES ROCHA', crm: 'CRM 38750-CE', especialidade: 'Medicina de Família', cidade: 'Fortaleza', uf: 'CE' },
  // Juazeiro do Norte
  { nome: 'DR. MANOEL CARVALHO LEITE', crm: 'CRM 17230-CE', especialidade: 'Clínica Médica', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DRA. NICÉIA BESSA SANTOS', crm: 'CRM 22540-CE', especialidade: 'Pediatria', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DR. OSVALDO PONTES FILGUEIRA', crm: 'CRM 16890-CE', especialidade: 'Ortopedia', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DRA. PRISCILA DANTAS LOPES', crm: 'CRM 24670-CE', especialidade: 'Ginecologia', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DR. RODRIGO PAIVA SAMPAIO', crm: 'CRM 19340-CE', especialidade: 'Cardiologia', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DRA. SILVANA MELO FAÇANHA', crm: 'CRM 28120-CE', especialidade: 'Neurologia', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DR. TARCÍSIO LIMA XIMENES', crm: 'CRM 15670-CE', especialidade: 'Dermatologia', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DRA. VIVIANE ALBUQUERQUE SOUSA', crm: 'CRM 30100-CE', especialidade: 'Medicina de Família', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DR. WESLLEY MAGALHÃES COSTA', crm: 'CRM 20940-CE', especialidade: 'Psiquiatria', cidade: 'Juazeiro do Norte', uf: 'CE' },
  { nome: 'DRA. XÊNIA PEREIRA BRAGA', crm: 'CRM 25310-CE', especialidade: 'Endocrinologia', cidade: 'Juazeiro do Norte', uf: 'CE' },
...
export function getEstadosMedicos(): string[] {
  const estados = [...new Set(MEDICOS_HAPVIDA.map(m => m.uf))].sort();
  return estados;
}

// Retorna cidades de um estado
export function getCidadesPorEstado(uf: string): string[] {
  const cidades = [...new Set(MEDICOS_HAPVIDA.filter(m => m.uf === uf).map(m => m.cidade))].sort();
  return cidades;
}
