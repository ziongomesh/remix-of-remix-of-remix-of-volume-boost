...
const INITIAL_ITEMS: DraggableItem[] = [
  ...
  { id: "verso", label: "Matriz 3 (Verso)", x: 57.14, y: 118.547, width: 85, height: 55, color: "rgba(0,200,0,0.35)" },
  { id: "qrcode", label: "QR Code", x: 155.017, y: 231.788, width: 77.192, height: 77.192, color: "rgba(255,165,0,0.45)" },
];
