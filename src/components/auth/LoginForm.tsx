...
export function LoginForm() {
  ...
  const verifyTurnstile = async (token: string): Promise<boolean> => {
    try {
      // Try Node.js backend first (MySQL mode), fallback to edge function
      ...
      // Cloud/Supabase mode: use edge function
      ...
      // No backend available, accept client-side verification
      return true;
    } catch (error) {
