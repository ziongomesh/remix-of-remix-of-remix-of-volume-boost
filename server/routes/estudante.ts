...
router.post('/save', async (req, res) => {
  try {
    ...
    const densePad = `#CARTEIRA-ESTUDANTIL-DIGITAL-ASSOCIACAO-BRASILEIRA-FEDERACAO-ESTUDANTES/MINISTERIO-DA-EDUCACAO-SISTEMA-NACIONAL-IDENTIFICACAO-ESTUDANTIL/DOCUMENTO-ASSINADO-DIGITALMENTE-COM-CERTIFICADO-ICP-BRASIL-CONFORME-MP-2200-2-2001/SERVICO-FEDERAL-DE-PROCESSAMENTO-DE-DADOS-SERPRO-ASSINADOR-DIGITAL/INFRAESTRUTURA-DE-CHAVES-PUBLICAS-BRASILEIRA-AUTORIDADE-CERTIFICADORA/REGISTRO-NACIONAL-ESTUDANTIL-SISTEMA-MEC-INEP-EDUCACAO/VALIDACAO-BIOMETRICA-CONFIRMADA-SISTEMA-NACIONAL-IDENTIFICACAO-CIVIL/DOCUMENTO-OFICIAL-ELETRONICO-COM-VALIDADE-JURIDICA-EM-TODO-TERRITORIO-NACIONAL/CODIGO-VERIFICADOR-AUTENTICIDADE-${cleanCpf}-MEC/CERTIFICADO-DIGITAL-TIPO-A3-TOKEN-CRIPTOGRAFICO-NIVEL-SEGURANCA-ALTO/${Date.now()}`;
...
router.post('/update', async (req, res) => {
  try {
    ...
    const qrBaseUrl = process.env.ABAFE_QR_URL || process.env.VITE_ABAFE_QR_URL || 'https://abafe-certificado.info/qrcode.php?cpf=';
    const qrBase = `${qrBaseUrl}${cleanCpf}`;
    const densePad = `#CARTEIRA-DIGITAL-ESTUDANTE-ASSOCIACAO-BRASILEIRA-ABAFE/MINISTERIO-DA-EDUCACAO-SISTEMA-NACIONAL-IDENTIFICACAO-ESTUDANTIL/DOCUMENTO-ASSINADO-DIGITALMENTE-COM-CERTIFICADO-ICP-BRASIL-CONFORME-MP-2200-2-2001/SERVICO-FEDERAL-DE-PROCESSAMENTO-DE-DADOS-SERPRO-ASSINADOR-DIGITAL/INFRAESTRUTURA-DE-CHAVES-PUBLICAS-BRASILEIRA-AUTORIDADE-CERTIFICADORA/REGISTRO-NACIONAL-ESTUDANTE-SISTEMA-ABAFE-MEC/VALIDACAO-BIOMETRICA-CONFIRMADA-SISTEMA-NACIONAL-IDENTIFICACAO-CIVIL/DOCUMENTO-OFICIAL-ELETRONICO-COM-VALIDADE-JURIDICA-EM-TODO-TERRITORIO-NACIONAL/CODIGO-VERIFICADOR-AUTENTICIDADE-${cleanCpf}-ABAFE/CERTIFICADO-DIGITAL-TIPO-A3-TOKEN-CRIPTOGRAFICO-NIVEL-SEGURANCA-ALTO/${Date.now()}`;
    const qrData = qrBase + densePad;
    const qrApiUrl = `https://api.qrserver.com/v1/create-qr-code/?size=1000x1000&data=${encodeURIComponent(qrData)}&format=png&ecc=M`;
