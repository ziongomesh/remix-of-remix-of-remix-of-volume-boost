            ...
            {step === 'welcome' ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Escolha um serviço para ver uma demonstração</p>
                </div>
              </div>
            )}
          </div>
          ...
          <CardContent className="p-6 pt-4">
            {step === 'welcome' ? (
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">Usaremos uma foto e assinatura padrão que podem ser reutilizadas nos módulos</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-3">
                ...
                <Button variant="ghost" onClick={handleSkip} className="w-full mt-2 text-muted-foreground">
                  Pular tutorial
                </Button>
              </div>
            )}
